...
function peg$parse(input, options) {
  ...
  var peg$f6 = function(id, exp) { return crearNodo('declaracionVariable', { id, exp }) };
  var peg$f7 = function(id, exp) { return crearNodo('declaracionVariable', { id, exp }) };
  var peg$f8 = function(id, exp) { return crearNodo('declaracionVariable', { id, exp }) };
  var peg$f9 = function(exp) { return crearNodo('print', { exp }) };
  var peg$f10 = function(dcls) { return crearNodo('bloque', { dcls }) };
  var peg$f11 = function(cond, stmtTrue, stmtFalse) { return stmtFalse };
  var peg$f12 = function(cond, stmtTrue, stmtFalse) { return crearNodo('if', { cond, stmtTrue, stmtFalse }) };
  var peg$f13 = function(cond, stmt) { return crearNodo('while', { cond, stmt }) };
  var peg$f14 = function(init, cond, inc, stmt) {
      return crearNodo('for', { init, cond, inc, stmt })
    };
  var peg$f15 = function() { return crearNodo('break') };
  ...
  var peg$f31 = function(num) { return crearNodo('unaria', { op: '-', exp: num }) };
  var peg$f32 = function(callee, args) { return args };
  var peg$f33 = function(callee, params) {
  ...
  var peg$f34 = function(arg, exp) { return exp };
  var peg$f35 = function(arg, args) { return [arg, ...args] };
  var peg$f36 = function(texto) { return crearNodo('string', { valor: texto.join('') }) };
  var peg$f37 = function(texto) { return crearNodo('char', { valor: texto.join('') }) };
  var peg$f38 = function() {return crearNodo('float', { valor: parseFloat(text(), 10) })};
  var peg$f39 = function(exp) { return crearNodo('agrupacion', { exp }) };
  var peg$f40 = function(id, args) { return crearNodo('instancia', { id, args: args || [] }) };
  var peg$f41 = function(id) { return crearNodo('referenciaVariable', { id }) };
  var peg$f42 = function() {return crearNodo('numero', { valor: parseInt(text(), 10) })};
  var peg$f43 = function(exp) { return crearNodo('agrupacion', { exp }) };
  var peg$f44 = function(id) { return crearNodo('referenciaVariable', { id }) };
  var peg$f45 = function() { return crearNodo('boolean', { valor: true }) };
  var peg$f46 = function() { return crearNodo('boolean', { valor: false }) };
